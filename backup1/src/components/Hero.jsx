    ...
    return (
        <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden bg-cosmic-bg">
            ...
            <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                ...
                >
                    <h2 className="text-star-blue font-medium tracking-widest mb-4 uppercase">Theoretical Physicist & Developer</h2>
                    <h1 className="text-5xl md:text-7xl font-display font-bold text-white mb-6 leading-tight">
                        Imagination is more important than <span className="text-transparent bg-clip-text bg-gradient-to-r from-star-blue to-star-purple">knowledge</span>.
                    </h1>
                    <p className="text-gray-400 text-lg md:text-xl mb-4 max-w-2xl mx-auto">
                        Crafting digital universes with code and creativity. Exploring the relativity of design and functionality.
                    </p>
                    <p className="text-star-blue text-sm mb-10 animate-pulse">
                        ✨ Click anywhere to generate photons at light speed ✨
                    </p>
